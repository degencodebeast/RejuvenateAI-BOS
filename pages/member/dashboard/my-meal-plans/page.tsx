...
<Flex align={'center' } gap={6}>
          ...
          <Heading size={'lg'} className="text-primaryGreen">Your Meal Plans</Heading> <Text className="bg-primaryGreen text-white rounded-full py-1 px-4 " fontSize={'sm'} fontWeight={'semibold'}>
{format(today,'E, d MMM yyyy')}
          </Text>
</Flex>
<Button className="bg-primaryGreen text-primaryBeige hover:bg-primaryYellow hover:text-primaryGreen">Add Meal Plan</Button>
          </Flex>
...
<TableContainer my={6} >
    <Table >
        ...
        <Td>
            ...
            <Button size={'sm'} variant={'outline'} rounded={'full'} className="text-primaryGreen border-primaryGreen">View Details</Button>
            </Flex>
            </Td>
